...
const permanentlyDeleteTournamentByID = catchAsync(async (req, res) => {
  ...
  try {
    ...
    return res
      ...
      .json(
        success_response(
          201,
          "Successfully deleted tournament from archived section",
          responsePayload,
          true
        )
      );
    ...
    return res
      ...
      .json(
        failed_response(
          400,
          "Something went wrong while deleting tournament from archived section ",
          { message: err.message },
          false
        )
      );
...
module.exports = permanentlyDeleteTournamentByID;