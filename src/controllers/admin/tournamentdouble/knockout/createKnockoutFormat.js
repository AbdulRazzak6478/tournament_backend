// const categoriesModel = require("../../models/knockoutFormat");
// const subCategoriesModel = require("../../models/knockoutFormat");
const tournamentModel = require("../../models/tournament");
const tournamentTeamModel = require("../../models/team");
const tournamentPlayerModel = require("../../models/participents");
const tournamentRoundsModel = require("../../models/Rounds");
const tournamentMatchModel = require("../../models/matches");
const tournamentKnockoutModel = require("../../models/knockoutFormat");
